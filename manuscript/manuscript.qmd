...
To improve certain academic equity issues, it is worthwhile focusing within disciplines and seeing how more local academic communities can provide more equity. To do this, it is worth giving a snapshot of specific fields. Indeed, instead of looking broadly at journal articles in STEM, or in several different kinds of journals, it can be worthwhile giving an idea of a more specific. For example, one paper explores authorship in Herpetology, showing that male authors outnumber female, but female authorship is increasing steadily across the last decade [@rock2021quantifying]. The current paper also focuses on music psychology as a discipline: within music psychology, there are many efforts to improve the field. There have been papers that provide a snapshot of the field to provide a rough overview of the state of affairs (e.g., @anglada2019visualizing) with suggestions of future directions to improve the field. [@eerola2023transparency] showcases how Open Science practices (e.g., preregistrations, sharing research materials, data, and analysis scripts) are relatively limited, and encourage authors in the field to start implementing such practices. @jakubowski2024 explores participant samples and musical stimuli used across a wide range of experiment to give an idea of how limited or generalizable the field is, which the view to see how – as a field – we need to diversify participant samples and stimuli to gain a more realistic understanding. In a similar way to these papers, the current paper aims to give a current overview of authorship in the field of music psychology.
