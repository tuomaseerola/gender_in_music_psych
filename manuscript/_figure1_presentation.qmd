...
fig1 <- ggplot(annual2,aes(x=YearRange,y=Odds_ratio,color=Type,group=Type,shape=separator))+
  ...
  xlab('Year range')+
  ylab('Female Author Odds Ratio (95%CI)')+
  theme_classic(base_size = 15)
print(fig1)

# apply dark theme
fig1 <- fig1 + dark_theme_bw(base_size = 16) + theme(legend.position="top")
...
ggsave(fig1,filename = "figure1_authorship_oddsratio_dark.png",width = 7.8,height = 5,dpi = 300)
