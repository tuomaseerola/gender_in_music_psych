...
position: bottom, 
[
A) Number of authors and B) women odds ratio for authorship types across the number of authors
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
