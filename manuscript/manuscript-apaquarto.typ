...
While we present analysis of gender of the authorships across the discipline-specific journal in a relatively simple manner here, there would be more elaborate ways into obtaining insights into the gendered career progression in music psychology; for instance, future work with the same data could analyse the precarity of career options as judged from the years of authorship attributions (see #link(<ref-lundine2018>)[Lundine et al., 2018];). One could also analyse the last author positions in more detail using direct contacts to the authors (interviews and surveys) and try to identify the factors contributing to the barriers experienced by women to take up senior author positions.
...
#par()[#text(size:0.5em)[#h(0.0em)]]
#v(-18pt)
We are grateful to Isabelle Peretz for suggesting a deeper look into the author types, and to our colleagues for their valuable input on the manuscript.
