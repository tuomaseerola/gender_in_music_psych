...
citestats_first$CI_lower<-NULL
citestats_first$CI_upper<-NULL
...
citestats_coauthor$CI_lower<-NULL
citestats_coauthor$CI_upper<-NULL
...
citestats_last$CI_lower<-NULL
citestats_last$CI_upper<-NULL
...
citestats_all$CI_lower<-NULL
citestats_all$CI_upper<-NULL
